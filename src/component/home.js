import RevolutionSlider from "./slider";
            ...
            <div className="container">
                ...
                <div className="row">
                    ...
                    <div className="col-lg-5 col-md-12 sm-margin-50px-bottom xs-margin-30px-bottom">
                        <img src="assets/miner/Finance-Behavior-by-Board-Room.jpg" alt="" className="border-radius-5 box-shadow-primary" />
                ...
                <div className="owl-carousel owl-theme testmonial-style5">
                    <div className="row testmonials-style5 sm-text-center">
                        <div className="col-md-12 col-lg-4 sm-margin-15px-bottom">
                            <img alt="image" src="./img//testmonials/t-4.jpg" />
                        </div>
                    ...
                    <div className="row testmonials-style5 sm-text-center">
                        <div className="col-md-12 col-lg-4 sm-margin-15px-bottom">
                            <img alt="image" src="./img//testmonials/t-5.jpg" />
                        </div>
                        <div className="col-md-12 col-lg-8">
                            <div className="data">
                    ...
                    <div className="row testmonials-style5 sm-text-center">
                        <div className="col-md-12 col-lg-4 sm-margin-15px-bottom">
                            <img alt="image" src="./img//testmonials/t-6.jpg" />
                        </div>
                        <div className="col-md-12 col-lg-8">
                            <div className="data">
                    ...
                    <div className="row testmonials-style5 sm-text-center">
                        <div className="col-md-12 col-lg-4 sm-margin-15px-bottom">
                            <img alt="image" src="./img//testmonials/t-8.jpg" />
                        </div>
                        <div className="col-md-12 col-lg-8">
                            <div className="data">
                    ...
                    <div className="row testmonials-style5 sm-text-center">
                        <div className="col-md-12 col-lg-4 sm-margin-15px-bottom">
                            <img alt="image" src="./img//testmonials/t-9.jpg" />
                        </div>
                        <div className="col-md-12 col-lg-8">
                            <div className="data">
                    ...
                    <div className="row testmonials-style5 sm-text-center">
                        <div className="col-md-12 col-lg-4 sm-margin-15px-bottom">
                            <img alt="image" src="./img//testmonials/t-10.jpg" />
                        </div>
                        <div className="col-md-12 col-lg-8">
                            <div className="data">
        ...
        <div className="section-clients bg-light-light">
            <div className="container">
                <div className="owl-carousel owl-theme clients" id="clients">
                    <div className="item"><img alt="partner-image" src="/img/partners/client-01.png" /></div>
                    <div className="item"><img alt="partner-image" src="./img//partners/client-02.png" /></div>
                    <div className="item"><img alt="partner-image" src="./img//partners/client-03.png" /></div>
                    <div className="item"><img alt="partner-image" src="./img//partners/client-04.png" /></div>
                    <div className="item"><img alt="partner-image" src="./img//partners/client-05.png" /></div>
                    <div className="item"><img alt="partner-image" src="./img//partners/client-06.png" /></div>
                    <div className="item"><img alt="partner-image" src="./img//partners/client-07.png" /></div>
                    <div className="item"><img alt="partner-image" src="./img//partners/client-08.png" /></div>
                    <div className="item"><img alt="partner-image" src="./img//partners/client-09.png" /></div>
                    <div className="item"><img alt="partner-image" src="./img//partners/client-10.png" /></div>
                </div>
            </div>
        </div>
        {/* end clients section */}
